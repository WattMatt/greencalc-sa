...
interface ExtractedTariff {
  ...
  generation_capacity_charge_per_kva?: number;
  legacy_charge_per_kwh?: number;
  service_charge_per_day?: number;
  administration_charge_per_day?: number;
  network_demand_charge_peak_per_kwh?: number;
  network_demand_charge_standard_per_kwh?: number;
