                ...
                <Table>
                  <TableHeader className="sticky top-0 bg-background z-10">
                    <TableRow>
                      ...
                      <TableHead className="text-right bg-yellow-500/5">Solar (R/kWh)</TableHead>
                      <TableHead className="text-right bg-yellow-500/5">Solar Income (R)</TableHead>
                      <TableHead className="text-right bg-blue-500/5">Batt (kWh)</TableHead>
                      <TableHead className="text-right bg-blue-500/5">Batt (R/kWh)</TableHead>
                      <TableHead className="text-right bg-blue-500/5">Batt Income (R)</TableHead>
                      <TableHead className="text-right bg-purple-500/5">Export (kWh)</TableHead>
                      <TableHead className="text-right bg-purple-500/5">Export (R/kWh)</TableHead>
                      <TableHead className="text-right bg-purple-500/5">Export Income (R)</TableHead>
                      <TableHead className="text-right">Demand (kVA)</TableHead>
                      <TableHead className="text-right">Demand (R/kVA)</TableHead>
