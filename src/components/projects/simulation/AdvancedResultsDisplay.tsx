                ...
                <Table className="min-w-[1800px]">
                  <TableHeader className="sticky top-0 bg-background z-10">
                    <TableRow>
                      ...
                      <TableHead className="text-right bg-yellow-500/5">Solar Rate (R/kWh)</TableHead>
                      ...
                      <TableHead className="text-right bg-blue-500/5">Batt Rate (R/kWh)</TableHead>
                      ...
                      <TableHead className="text-right bg-purple-500/5">Export Rate (R/kWh)</TableHead>
