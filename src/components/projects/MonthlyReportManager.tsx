...
export function MonthlyReportManager({ projectId }: MonthlyReportManagerProps) {
    const [editingProposalId, setEditingProposalId] = useState<string | null>(null);
    const [isEditing, setIsEditing] = useState(false);

    const { data: proposals, isLoading } = useQuery({
        queryKey: ["project-monthly-reports", projectId],
        queryFn: async () => {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Manage and track monthly reports for this project</p>
                </div>
                ...
                {proposals && proposals.length > 0 ? (
                    ...
                    <Card className="border-dashed">
                        <CardContent className="py-12 flex flex-col items-center justify-center text-center">
                            ...
                            <h3 className="font-semibold mb-1">No monthly reports yet</h3>
